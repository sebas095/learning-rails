...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { slider_id: @presentation.slider_id, title: @presentation.title, user_id: @presentation.user_id } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { slider_id: @presentation.slider_id, title: @presentation.title, user_id: @presentation.user_id } }
